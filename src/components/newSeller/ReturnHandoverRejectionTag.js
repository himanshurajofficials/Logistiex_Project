...
const ReturnHandoverRejectionTag = ({ route }) => {
            ...
            <Box flex={1} bg="#fff" width="auto" maxWidth="100%">
                ...
                <ScrollView style={styles.homepage} showsVerticalScrollIndicator={true} showsHorizontalScrollIndicator={false}>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', alignSelf: 'center', marginTop: 20, marginBottom: 20 }}>
                        <Button w="100%" size="lg" bg="#D3D3D3" >Return Handover Rejection Tag</Button>
                    </View>

                    <View style={{ width: '90%', flexDirection: 'row', justifyContent: 'center', alignSelf: 'center', marginTop: 20 }}>
                        <Button w="100%" size="lg" bg="#004aad" >Damaged Shipment</Button>
                    </View>

                    <View style={{ width: '90%', flexDirection: 'row', justifyContent: 'center', alignSelf: 'center', marginTop: 20 }}>
                        <Button w="100%" size="lg" bg="#004aad" >Wrong Packaging</Button>
                    </View>

                    <View style={{ width: '90%', flexDirection: 'row', justifyContent: 'center', alignSelf: 'center', marginTop: 20 }}>
                        <Button w="100%" size="lg" bg="#004aad" >Empty Parcel</Button>
                    </View>

                </ScrollView>
                <View style={{ width: '90%', flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: 10 }}>
                    <Button w="40%" size="lg" bg="#004aad" >Reject Shipment</Button>
                    <Button w="40%" size="lg" bg="#004aad" >Tag Shipment</Button>
                </View>
                <Center>
...
export default ReturnHandoverRejectionTag;
