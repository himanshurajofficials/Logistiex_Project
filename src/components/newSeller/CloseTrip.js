    ...
    return (
        <NativeBaseProvider>
            ...
            <Box flex={1} bg="#fff" width="auto" maxWidth="100%">
                ...
                <Input placeholder="Vehicle Number" size="md" marginX={10}  />
                <Input placeholder="Input vehicle KMs" size="md" marginX={10}  />
                    

                    <View style={{ width: '90%', flexDirection: 'row', justifyContent: 'center', alignSelf: 'center', marginTop: 20 }}>
                        <Button w="50%" size="lg" bg="#004aad" >Click Image</Button>
                    </View>
                ...
                <View style={{ width: '90%', flexDirection: 'row', justifyContent: 'center', alignSelf: 'center', marginTop: 10 }}>
                    <Button w="40%" size="lg" bg="#004aad" >Close Trip</Button>
                </View>
                <Center>
